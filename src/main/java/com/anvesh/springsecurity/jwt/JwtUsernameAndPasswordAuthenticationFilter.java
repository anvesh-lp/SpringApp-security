...
/*   Process of authorization
     User send a request it is validated in attemptAuthentication mehtod
     Upon successful validation jwt token is generated in successfulAuthentication method and is attached to response
     */
...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtUsernameAndPasswordAuthenticationFilter(AuthenticationManager authenticationManager, JwtConfig config, SecretKey key) {
    ...
    //    To validate the authentication of user requests
    @Override
